...
public:
	...
	void PathUpdate(float fElapsedTime)
	{
		...
		player.vx = (vPath[pathCnt].x - vPath[pathCnt - 1].x) / fDuration; // vx and vy don't actually do anything, but might help in animations based on velocity later
